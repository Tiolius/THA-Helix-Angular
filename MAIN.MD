...
---
**<span style="color:red">Важно!</span> Задание рекомендуется выполнять с использованием встроенной функциональной дизайн системы ADAPT с использованием встроенных сервисов для получения данных**
